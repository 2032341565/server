...
package cn.wildfirechat.im.spi.impl;

import cn.wildfirechat.common.ErrorCode;
import cn.wildfirechat.im.interception.InterceptHandler;
import cn.wildfirechat.im.interception.messages.InterceptAcknowledgedMessage;
...
import cn.wildfirechat.im.server.ConnectionDescriptor;
import cn.wildfirechat.im.server.ConnectionDescriptorStore;
import cn.wildfirechat.im.server.Server;
import cn.wildfirechat.im.server.netty.NettyUtils;
import cn.wildfirechat.im.spi.impl.security.AES;
import cn.wildfirechat.im.spi.security.IAuthenticator;
import cn.wildfirechat.im.spi.security.IAuthorizator;
import cn.wildfirechat.mqtt.*;
...
import cn.wildfirechat.im.spi.IMessagesStore;
import cn.wildfirechat.im.spi.IMessagesStore.StoredMessage;
...
import static cn.wildfirechat.im.spi.impl.InternalRepublisher.createPublishForQos;
import static cn.wildfirechat.im.spi.impl.Utils.readBytesAndRewind;
import static cn.wildfirechat.mqtt.MqttConnectReturnCode.*;
import static cn.wildfirechat.mqtt.MqttMessageIdVariableHeader.from;
import static cn.wildfirechat.mqtt.MqttQoS.*;
...
public class ProtocolProcessor {
    ...
    public void processConnect(Channel channel, MqttConnectMessage msg) {
        ...
        final boolean success = descriptor.assignState(ConnectionDescriptor.ConnectionState.SESSION_CREATED, ConnectionDescriptor.ConnectionState.ESTABLISHED);
        if (!success) {
            channel.close();
            return;
        }
    ...
    private boolean dropStoredMessages(ConnectionDescriptor descriptor, String clientID) {
        final boolean success = descriptor.assignState(ConnectionDescriptor.ConnectionState.ESTABLISHED, ConnectionDescriptor.ConnectionState.MESSAGES_DROPPED);
        if (!success) {
            return false;
        }
